                                ...
                                .executes(ctx -> {
                                    proxy.getPlayer(ctx.getArgument("player", String.class)).ifPresent(player->{
                                        ...
                                        if (ctx.getSource() instanceof Player senderPlayer)
                                            component = VelocityCore.get().messages.getMessage(Messages.Keys.Commands.MESSAGE_PLAYER, senderPlayer.getUsername(), message);
                                        else component = VelocityCore.get().messages.getMessage(Messages.Keys.Commands.MESSAGE_CONSOLE, message);
