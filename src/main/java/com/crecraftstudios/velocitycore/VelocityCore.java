...
import com.crecraftstudios.velocitycore.commands.*;
import com.crecraftstudios.velocitycore.events.LoginEvents;
import com.crecraftstudios.velocitycore.events.ServerEvents;
import com.crecraftstudios.velocitycore.json.Bans;
import com.crecraftstudios.velocitycore.json.Config;
import com.crecraftstudios.velocitycore.json.Messages;
import com.crecraftstudios.velocitycore.json.Whitelist;
import com.crecraftstudios.velocitycore.network.HttpServer;
import com.crecraftstudios.velocitycore.utils.ServerUtils;
...
public class VelocityCore {
    ...
    @Inject
    public VelocityCore(ProxyServer proxy, Logger logger, @DataDirectory Path dir) {
        this.proxy =proxy;
        this.logger=logger;
