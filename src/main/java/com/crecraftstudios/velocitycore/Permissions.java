...
public class Permissions {
    public static class Commands {
        public static final String WHITELIST = "velocityplus.admin.whitelist";
        public static final String SET_LOBBY = "velocityplus.admin.setlobby";
        public static final String FIND = "velocityplus.find";
        public static final String HUB = "velocityplus.hub";
